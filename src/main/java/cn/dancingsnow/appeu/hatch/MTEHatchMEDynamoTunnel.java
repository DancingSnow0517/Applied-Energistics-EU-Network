...
public class MTEHatchMEDynamoTunnel extends MTEHatchDynamoTunnel
    ...
    public MTEHatchMEDynamoTunnel(int id, String name, String regionalName, int tier, int maximumAmperage) {
        super(id, name, regionalName, validateTier(tier), validateAmperage(maximumAmperage));
    }

    public MTEHatchMEDynamoTunnel(String name, int tier, int maximumAmperage, String[] description,
        ITexture[][][] textures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity baseMetaTileEntity) {
        return new MTEHatchMEDynamoTunnel(mName, mTier, maxAmperes, mDescriptionArray, mTextures);
    }
