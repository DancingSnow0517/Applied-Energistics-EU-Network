...
public class MTEHatchMEEnergyTunnel extends MTEHatchEnergyTunnel
    ...
    public void onPostTick(IGregTechTileEntity baseMetaTileEntity, long tick) {
        ...
        if (tick == 1L || MEHatchTransferPolicy.shouldTransfer(tick)) {
            ...
            if (stored < capacity) {
                ...
                if (port != null) {
                    long limit = MEHatchTransferPolicy.batchSize(V[mTier], getAmperes());
    ...
    public ITexture[] getTexturesActive(ITexture aBaseTexture) {
        return new ITexture[] { aBaseTexture, AppEUTextures.BlockIcons.OVERLAYS_ME_ENERGY_IN_LASER_TEXTURE };
    }
