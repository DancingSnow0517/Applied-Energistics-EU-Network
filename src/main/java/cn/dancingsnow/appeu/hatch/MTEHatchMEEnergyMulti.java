...
public class MTEHatchMEEnergyMulti extends MTEHatchEnergyMulti
    ...
    public MTEHatchMEEnergyMulti(int id, String name, String regionalName, int tier, int amperage) {
        super(id, name, regionalName, validateTier(tier), validateAmperage(amperage));
        fixedAmperage = amperage;
    }

    public MTEHatchMEEnergyMulti(String name, int tier, int amperage, String[] description, ITexture[][][] textures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity baseMetaTileEntity) {
        return new MTEHatchMEEnergyMulti(mName, mTier, fixedAmperage, mDescriptionArray, mTextures);
    }
    ...
    public long maxAmperesIn() {
        return fixedAmperage + (fixedAmperage >> 2);
    }
    ...
    private static int validateAmperage(int amperage) {
        if (amperage != 4 && amperage != 16 && amperage != 64) {
            throw new IllegalArgumentException("multi-amp ME energy amperage must be 4, 16, or 64: " + amperage);
        }
        return amperage;
    }
}
